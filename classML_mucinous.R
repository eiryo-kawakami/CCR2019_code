...
#label <- c("clear\ncell","serous","endo\nmetrioid","mucinous")
order <- c("mucinous","non_mucinous")
label <- c("mucinous","non_mucinous")
...
for (method in method_list){
	...
	if (class(e) != "try-error") {
		...
		roc.res <- roc(data_test_merged$class, pred$mucinous)
