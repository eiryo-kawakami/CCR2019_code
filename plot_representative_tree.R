...
model <- randomForest(class ~ ., data=data_train_merged, importance=TRUE, ntree=4000, mtry = 17, do.trace=100)

for (k in c(1:2)){

pdf(paste0("cancer_age_171122_representative_tree",k,".pdf")
reprtree:::plot.getTree(model,k=k)
dev.off()
