...
for (method in method_list){
	...
	if (class(e) != "try-error") {
		...
		roc.res <- roc(data_test_merged$class, pred$malignant)
		auc_list <- c(auc_list,pROC::auc(roc.res))
		rocplot <- paste("../results_171122/ovary_ROCplot_",method,"_",k,"-fold_",class,".pdf",sep='')
		...
		blnplot <- paste("../results_171122/ovary_balloonplot_",method,"_",k,"-fold_",class,".pdf",sep='')
